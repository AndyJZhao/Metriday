...
function StatsPage({ api, dateKey, setDateKey, setPage, projectScopeID, setProjectScopeID }) {
  ...
  const periodRows = statsPeriod === "week" || statsPeriod === "lastWeek" || statsPeriod === "day" || statsPeriod === "yesterday" ? dayRows : Array.from({ length: Math.ceil(dayRows.length / 7) }, (_, index) => {
