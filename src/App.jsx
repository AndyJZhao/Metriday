...
function StatsPage({ api, dateKey, setDateKey, setPage, projectScopeID, setProjectScopeID }) {
  ...
  const statsPeriodLabel = statsPeriod === "day" ? "Today" : statsPeriod === "week" ? "This Week" : statsPeriod === "month" ? "This Month" : "This Year";
  const statsShareText = [
    "Metriday Stats",
    `${statsPeriodLabel} · ${statsBounds.start}–${statsBounds.end}`,
