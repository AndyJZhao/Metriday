...
function WebActivityTimeline({ activities, dateKey, api, onSelect, onEditTimeEntry, orientation: requestedOrientation = "horizontal", onToggleOrientation }) {
