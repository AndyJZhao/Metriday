...
expect(!PlanTask(title: "Missing time").isScheduled, "Tasks without a complete time range should not be Focus targets")
expect(!PlanTask(title: "Reverse time", startMinute: 600, endMinute: 540).isScheduled, "Reverse time ranges should not be Focus targets")
expect(PlanTask(title: "Scheduled", startMinute: 540, endMinute: 600).isScheduled, "Valid time ranges should be schedulable Focus targets")
